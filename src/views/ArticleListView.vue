            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="loop-grid loop-big">
                        <div class="row">
                            <article class="first-post mb-30 hover-up animated col-lg-12"
                                ...
                                <div class="position-relative overflow-hidden">
                                    ...
                                    <div class="post-thumb border-radius-15">
                                        <a href="/article/1">
                                            <img class="border-radius-15" src="/assets/images/blog/blog-16.png"
                                                alt="" />
                                        </a>
                                    </div>
                                </div>
                                <div class="entry-content">
                                    <h2 class="post-title mb-20">
                                        <a href="/article/1">Enjoy My Favourite Molten Chocolate Cake in This
                                            Autumn </a>
                                    </h2>
                                    <p class="post-exerpt font-medium text-muted mb-30">TAliquam hendrerit lorem mi nunc
                                        sit aliquam nec leo, ut integer nisi, iaculis dictumst at diam libero, elit
                                        pharetra morbi urna nunc, et at nisl, pellentesque massa nec. Aenean ullamcorper
                                        eu augue vitae tempor. Suspendisse potenti. Nulla facilisi. Sed venenatis mollis
                                        lacinia.</p>
                                    <div class="mb-20 entry-meta meta-2">
                                        ...
                                        <a href="/article/1" class="btn btn-sm">Read more<i
                            ...
                            <article class="first-post mb-30 hover-up animated col-lg-12"
                                ...
                                <div class="position-relative overflow-hidden">
                                    ...
                                    <div class="post-thumb border-radius-15">
                                        <a href="/article/1">
                                            <img class="border-radius-15" src="/assets/images/blog/blog-17.png"
                                                alt="" />
                                        </a>
                                    </div>
                                </div>
                                <div class="entry-content">
                                    <h2 class="post-title mb-20">
                                        <a href="/article/1">The Intermediate Guide to Healthy Food Sticky
                                            Ginger Rice</a>
                                    </h2>
                                    <p class="post-exerpt font-medium text-muted mb-30">TAliquam hendrerit lorem mi nunc
                                        sit aliquam nec leo, ut integer nisi, iaculis dictumst at diam libero, elit
                            ...
                            <article class="first-post mb-30 hover-up animated col-lg-12"
                                ...
                                <div class="position-relative overflow-hidden">
                                    ...
                                    <div class="post-thumb border-radius-15">
                                        <a href="/article/1">
                                            <img class="border-radius-15" src="/assets/images/blog/blog-18.png"
                                                alt="" />
                                        </a>
                                    </div>
                                </div>
                                <div class="entry-content">
                                    <h2 class="post-title mb-20">
                                        <a href="/article/1">Harissa Chickpeas with Whipped Feta Sticky
                                            Ginger</a>
                                    </h2>
                                    <p class="post-exerpt font-medium text-muted mb-30">TAliquam hendrerit lorem mi nunc
                                        sit aliquam nec leo, ut integer nisi, iaculis dictumst at diam libero, elit
