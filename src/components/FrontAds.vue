     ...
     <div class="modal fade custom-modal" id="onloadModal" tabindex="-1" aria-labelledby="onloadModalLabel" aria-hidden="true">
        <div class="modal-dialog" style="width: 700px;">
            <div class="modal-content" style="overflow: hidden;">
                <img style="position: absolute;top: 0;left: 0;" src="/assets/images/banner/detol-banner.jpg" alt="">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                <div class="modal-body">
                    <div class="deal" style="background: transparent;">
                        <div class="deal-top">
                            <!-- <h6 class="mb-10 text-brand-2">Deal of the Day</h6> -->
                        </div>
                        <!-- <div class="deal-content detail-info">
                            <h4 class="product-title"><a href="shop-product-right.html" class="text-heading">Nature's Way for your family's health</a></h4>
                            <div class="clearfix product-price-cover">
                                <div class="product-price primary-color float-left">
                                    <span class="current-price text-brand">Rp. 110,000</span>
                                    <span>
                                        <span class="save-price font-md color3 ml-15">26% Off</span>
                                        <span class="old-price font-md ml-15">Rp. 250,000</span>
                                    </span>
                                </div>
                            </div>
                        </div> -->
                        <div class="deal-bottom" style="margin-top: 300px;">
