<template>
    <section class="section-padding pb-5" style="margin-bottom: 50px;" v-show="!isExpired">
        <div class="container">
            <div class="section-title wow animate__animated animate__fadeIn">
                <div class="d-flex flex-row">
                    <div class="page-clip"></div>
                    <!-- <h3 class="">Flash Sale</h3> -->
                    <img style="width: 200px;object-fit: contain;" src="/assets/images/theme/Flashtime.png" alt="">

                    <div class="timer-container" style="margin-left: 30px;margin-top: 6px;">
                ...
                <ul class="nav nav-tabs links" id="myTab-2" role="tablist" v-for="title in flashsale" :key="title.id">
                    ...
                    <li class="nav-item" role="presentation">
                        ...
                        <div style="width: 100%;height: 4px; background: #b22a2e;margin-top: 15px" v-show="title.id === selecteditem"></div>
                    </li>
            ...
            <div class="row">
                <div class="col-lg-3 d-none d-lg-flex wow animate__animated animate__fadeIn">
                    <div class="banner-img style-2">
                        <Carousel :autoplay="2000" :itemsToShow="1" :wrapAround="true" :transition="1000">
                ...
                <div class="col-lg-9 col-md-12 wow animate__animated animate__fadeIn" data-wow-delay=".4s">
                    <div class="tab-content" id="myTabContent-1" v-for="flash in flashsale" :key="flash.id">
                        ...
                        <div v-show="flash.id === selecteditem">
                            <Splide :options="{ rewind: true,
                                                ...
                                                snap: 'center',
                                                arrows: true,
                                                gap: '1rem'}" aria-label="My Favorite Images">
                                <SplideSlide v-for="prod in flash.products" :key="prod.id">
                                    <div class="product-cart-wrap" style="height: 520px;">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a :href="'/product/' + prod.id">
                                                    <img class="default-img" :src="getProductImage(prod.image1)" alt="" />
                                                    <img class="hover-img" :src="getProductImage(prod.image2)" alt="" />
                                                </a>
                                            </div>
                                        ...
                                        <div class="product-content-wrap">
                                            ...
                                            <h2 style="font-size: 12pt;"><a href="shop-product-right.html">{{ prod.name }}</a></h2>
                                            ...
                                            <div class="sold mt-15 mb-15">
                                                <div class="progress mb-5">
                                                    <div :class="{'progress-bar-low' : countProductSold(prod.sold, prod.qty) <= 30, 
                                                                  'progress-bar-med' : countProductSold(prod.sold, prod.qty) > 30 && countProductSold(prod.sold, prod.qty) <= 60,
                                                                  'progress-bar-high' : countProductSold(prod.sold, prod.qty) > 60 && countProductSold(prod.sold, prod.qty) <= 90,
                                                                  'progress-bar' : countProductSold(prod.sold, prod.qty) > 90}" role="progressbar" 
                                                         :style="{width: countProductSold(prod.sold, prod.qty) + '%'}" 
                                                         aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                                <span class="font-xs text-heading" v-show="countProductSold(prod.sold, prod.qty) <= 90">{{ prod.qty - prod.sold}} Stock Left</span>
                                                <span class="font-xs text-heading" v-show="countProductSold(prod.sold, prod.qty) > 90">Run Out Soon</span>
                                            </div>
                                            <a href="shop-cart.html" class="btn w-100" style="position: absolute;bottom: 0;left: 0;border-radius: 0;"><i class="fi-rs-shopping-cart mr-5"></i>Add To Cart</a>
                                        </div>
                                    </div>
                                </SplideSlide>
                            </Splide>
...
export default {
    ...
    methods: {
        ...
        countdownTimer(){
            ...
            var countDownDate = new Date("2024-02-29 23:59:00").getTime();
            setInterval(() => {
